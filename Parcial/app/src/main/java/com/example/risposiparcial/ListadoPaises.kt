...
class ListadoPaises : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lsvPaises.setOnItemClickListener{parent,view, position, id ->
            var PaisesDetailIntent = Intent(this,DetallePais::class.java)
            PaisesDetailIntent.putExtra("PaisDetalle",arrayDeobjetosDePaises[position])
            startActivity(PaisesDetailIntent)
        }
